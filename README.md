...
Bonacchi, Chiara; Witte, Jessica; Altaweel, Mark. 2024. Political uses of the ancient past on social media are predominantly negative and extreme. <i>PLOS One</i>.
...
The code has been developed for the article 'Political uses of the ancient past on social media are not predominantly negative'. It is provided in /src/sentiment/analysis.py. This module combines all the libraries above and provides output to facilitate assessment of sentiment data.
